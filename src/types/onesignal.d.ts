...
declare module 'react-native-onesignal' {
    ...
    export interface PermissionSubscriptionState {
        emailAddress?: string;
    ...
    export interface OneSignal {
         ...
         */
        getTags(handler: (receivedTags: Record<string, string>) => void): void;
         ...
         */
        getPermissionSubscriptionState(handler: (status: PermissionSubscriptionState) => void): void;
        ...
        addEventListener(type: 'ids', handler: (device: Device) => void): void;
        ...
        removeEventListener(type: 'ids', handler: (device: Device) => void): void;

        promptForPushNotificationsWithUserResponse(callback: (permission: any) => void): void;
    }
